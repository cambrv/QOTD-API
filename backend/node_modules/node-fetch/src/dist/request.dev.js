...
function (_Body) {
  ...
  function Request(input) {
    ...
    if (referrer === '') {
      ...
      var parsedReferrer = new URL(referrer); // §5.4, Request constructor steps, step 15.3.3, 15.3.4
    ...
    _this.insecureHTTPParser = init.insecureHTTPParser || input.insecureHTTPParser || false; // §5.4, Request constructor steps, step 16.
...
var getNodeRequestOptions = function getNodeRequestOptions(request) {
  ...
  var headers = new _headers["default"](request[INTERNALS].headers); // Fetch step 1.3
  ...
  if (request.body !== null) {
    var totalBytes = (0, _body.getTotalBytes)(request); // Set Content-Length if totalBytes is a number (that is not NaN)
  ...
  var search = (0, _getSearch.getSearch)(parsedURL); // Pass the full URL directly to request(), but overwrite the following
  // options:
