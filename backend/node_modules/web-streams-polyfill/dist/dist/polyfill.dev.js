...
(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  function CreateAsyncFromSyncIterator(syncIteratorRecord) {
    ...
    var _a; // Wrap the sync iterator inside a sync iterable, so we can use it with yield*.


    var syncIterable = (_a = {}, _a[SymbolPolyfill.iterator] = function () {
      return syncIteratorRecord.iterator;
    }, _a); // Create an async generator function and immediately invoke it.
  ...
  var _a; // We cannot access %AsyncIteratorPrototype% without non-ES2018 syntax, but we can re-create it.
  ...
  function () {
    ...
    ReadableStreamDefaultController.prototype[ReleaseSteps] = function () {// Do nothing.
    };
