...
(function (global, factory) {
  ...
  var originalPromiseReject = Promise.reject.bind(originalPromise); // https://webidl.spec.whatwg.org/#a-new-promise
  ...
  var _queueMicrotask2 = function _queueMicrotask(callback) {
    if (typeof queueMicrotask === 'function') {
      _queueMicrotask2 = queueMicrotask;
    } else {
      var resolvedPromise = promiseResolvedWith(undefined);

      _queueMicrotask2 = function _queueMicrotask(cb) {
        return PerformPromiseThen(resolvedPromise, cb);
      };
    }
  ...
  if (_typeof(Symbol.toStringTag) === 'symbol') {
  ...
  ***************************************************************************** */
  ...
  var _TransferArrayBuffer = function TransferArrayBuffer(O) {
    if (typeof O.transfer === 'function') {
      _TransferArrayBuffer = function TransferArrayBuffer(buffer) {
    ...
    return _TransferArrayBuffer(O);
  };

  var _IsDetachedBuffer = function IsDetachedBuffer(O) {
    if (typeof O.detached === 'boolean') {
      _IsDetachedBuffer = function IsDetachedBuffer(buffer) {
  ...
  function CreateAsyncFromSyncIterator(syncIteratorRecord) {
    ...
    var syncIterable = _defineProperty({}, Symbol.iterator, function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.t0 = __await;
                _context.t1 = __await;
                return _context.delegateYield(__asyncDelegator(__asyncValues(syncIterable)), "t2", 3);
  ...
  var AsyncIteratorPrototype = _defineProperty({}, SymbolAsyncIterator, function () {
    return this;
  });
  ...
  Object.setPrototypeOf(ReadableStreamAsyncIteratorPrototype, AsyncIteratorPrototype); // Abstract operations for the ReadableStream.
  ...
  function () {
    ...
    _createClass(ReadableStreamBYOBRequest, [{
      ...
      value: function respond(bytesWritten) {
        ...
        if (_IsDetachedBuffer(this._view.buffer)) {
      ...
      value: function respondWithNewView(view) {
        ...
        if (_IsDetachedBuffer(view.buffer)) {
  ...
  function ReadableByteStreamControllerFillPullIntoDescriptorFromQueue(controller, pullIntoDescriptor) {
    ...
    var maxAlignedBytes = maxBytesFilled - remainderBytes; // A descriptor for a read() request that is not yet filled up to its minimum length will stay at the head
  ...
  function ReadableByteStreamControllerPullInto(controller, view, min, readIntoRequest) {
    ...
    try {
      buffer = _TransferArrayBuffer(view.buffer);
    } catch (e) {
  ...
  function ReadableByteStreamControllerEnqueue(controller, chunk) {
    ...
    if (_IsDetachedBuffer(buffer)) {
      throw new TypeError('chunk\'s buffer is detached and so cannot be enqueued');
    }

    var transferredBuffer = _TransferArrayBuffer(buffer);

    if (controller._pendingPullIntos.length > 0) {
      var firstPendingPullInto = controller._pendingPullIntos.peek();

      if (_IsDetachedBuffer(firstPendingPullInto.buffer)) {
        throw new TypeError('The BYOB request\'s buffer has been detached and so cannot be filled with an enqueued chunk');
      }

      ReadableByteStreamControllerInvalidateBYOBRequest(controller);
      firstPendingPullInto.buffer = _TransferArrayBuffer(firstPendingPullInto.buffer);
  ...
  function ReadableByteStreamControllerRespond(controller, bytesWritten) {
    ...
    firstDescriptor.buffer = _TransferArrayBuffer(firstDescriptor.buffer);
  ...
  function ReadableByteStreamControllerRespondWithNewView(controller, view) {
    ...
    firstDescriptor.buffer = _TransferArrayBuffer(view.buffer);
  ...
  function SetUpReadableByteStreamControllerFromUnderlyingSource(stream, underlyingByteSource, highWaterMark) {
    ...
    if (underlyingByteSource.cancel !== undefined) {
      ...
      cancelAlgorithm = function cancelAlgorithm() {
        return promiseResolvedWith(undefined);
      };
    }
  ...
  function WritableStreamAbort(stream, reason) {
    ...
    (_a = stream._writableStreamController._abortController) === null || _a === void 0 ? void 0 : _a.abort(reason); // TypeScript narrows the type of `stream._state` down to 'writable' | 'erroring',
  ...
  function SetUpWritableStreamDefaultControllerFromUnderlyingSink(stream, underlyingSink, highWaterMark, sizeAlgorithm) {
    ...
    if (underlyingSink.write !== undefined) {
      ...
      writeAlgorithm = function writeAlgorithm() {
        return promiseResolvedWith(undefined);
      };
    }
  ...
  var globals = getGlobals(); /// <reference types="node" />
  ...
  function () {
    ...
    _createClass(ReadableStreamDefaultController, [{
      ...
      key: ReleaseSteps,
      value: function value() {// Do nothing.
      }
    }, {
      key: "desiredSize",
      get: function get() {
  ...
  function TransformStreamDefaultSinkAbortAlgorithm(stream, reason) {
    ...
    var readable = stream._readable; // Assign the _finishPromise now so that if _cancelAlgorithm calls readable.cancel() internally,
  ...
  function TransformStreamDefaultSinkCloseAlgorithm(stream) {
    ...
    var readable = stream._readable; // Assign the _finishPromise now so that if _flushAlgorithm calls readable.cancel() internally,
  ...
  function TransformStreamDefaultSourceCancelAlgorithm(stream, reason) {
    ...
    var writable = stream._writable; // Assign the _finishPromise now so that if _flushAlgorithm calls writable.abort() or
